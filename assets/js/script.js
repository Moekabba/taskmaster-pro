...
// ------event and call back function ----
$(".list-group").on("click", "p", function () {
  var text = $(this).text().trim();
  // creating textArea
  var textInput = $("<textarea>").addClass("form-control").val(text);
  // replacxing p with textInput/area
  $(this).replaceWith(textInput);
  // hight light text area when clicked
  textInput.trigger("focus");
  // console.log(text);
});
// new even delegation for edited tax area
...
// again, ensuring that due dates turn into text inputs when clicked,
